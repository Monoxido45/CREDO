...
methods = ["credo_GP","credo_QNN", "credo_BART_adap", "credo_BART_fixed",
           "credo_GP_fixed", "credo_QNN_fixed", "credo_QNN_ens", 
           "credo_QNN_ens_fixed", "cqr", "cqrr", "uacqrs", "uacqrp", "EPIC"]
